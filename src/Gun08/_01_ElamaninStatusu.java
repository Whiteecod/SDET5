...
public class _01_ElamaninStatusu extends BaseDriver {
    ...
    public void test() {
        ...
        System.out.println("sali.isDisplayed() = " + cumartesi.isDisplayed());
        System.out.println("sali.isEnabled() = " + cumartesi.isEnabled());
        System.out.println("sali.isSelected() = " + cumartesi.isSelected());
